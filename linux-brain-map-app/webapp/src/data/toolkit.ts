...
export const PYTHON_SCRIPTS = [
  {
    ...
    file: 'log_anomaly.py',
    modules: [4, 6, 11],
    description: 'Поиск аномалий в логах (анализ частоты событий)',
  ...
  },
  {
    ...
    file: 'port_scan.py',
    modules: [11],
    description: 'Быстрый сканер портов на чистом Python без nmap',
  ...
  },
  {
    ...
    file: 'cve_monitor.py',
    modules: [12],
    description: 'Мониторинг свежих CVE уязвимостей через NVD API',
