...
export const MODULES: Module[] = [
  ...
  },
  {
    ...
    table: [
      ...
      { entity: 'open/read', where: 'strace -e file', signal: 'доступ к файлам' },
  ...
  },
  {
    ...
    table: [
      { entity: 'Mutex', where: 'strace futex', signal: 'блокировка userspace' },
      { entity: 'Spinlock', where: 'ядро', signal: 'busy-wait, коротко' },
  ...
  },
  {
    ...
    table: [
      { entity: 'VFS', where: '/proc/mounts', signal: 'единый API' },
      { entity: 'Inode', where: 'ls -i, stat', signal: 'метаданные' },
      { entity: '/etc', where: 'hash baseline', signal: 'конфигурация' },
      { entity: '/tmp', where: 'ls -ld /tmp', signal: 'sticky bit' },
    ],
    decisions: [
  ...
  },
  {
    ...
    table: [
      { entity: 'SUID', where: 'find -perm -4000', signal: 'запуск от root' },
      { entity: 'Capabilities', where: 'getcap', signal: 'частичный root' },
      { entity: 'Namespaces', where: 'lsns', signal: 'изоляция Docker' },
